...
class DmodClient:
    ...
    def dataset_client(self) -> DatasetClient:
        if self._dataset_client is None:
            if self._bypass_request_service:
                ...
                self._dataset_client = DatasetExternalClient(ssl_directory=self.requests_ssl_dir, endpoint_uri=self.requests_endpoint_uri)
        return self._dataset_client

    # TODO: aaraney, need one of these for ngen cal
    @property
    ...
    # TODO: aaraney add submit ngen_cal_request
